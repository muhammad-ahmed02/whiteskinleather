...
export const HeroTexts = {
    ...
    thirdText: "Leather safety products are essential items designed to provide protection and durability in various industrial and personal safety applications.",
